...
class GitUpdateManager(UpdateManager):
    ...
    def _check_github_for_update(self):
        ...
        # find newest commit
        for curCommit in gh.commits('fuzeman', 'Sick-Beard-Ex', self.branch):
    ...
    def set_newest_text(self):
        ...
        if self._newest_commit_hash:
            url = 'http://github.com/fuzeman/Sick-Beard-Ex/compare/'+self._cur_commit_hash+'...'+self._newest_commit_hash
        else:
            url = 'http://github.com/fuzeman/Sick-Beard-Ex/commits/'
